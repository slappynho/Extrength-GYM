...
public class Preference {
    ...
    private String statement_descriptor = "GymApp/MindHub";
    private String external_reference = "Gym";
    public class back_urls {
        private String success = "http://localhost:8080/web/products.html";
        private String failure = "http://localhost:8080/web/products.html";
        private String pending = "http://localhost:8080/web/index.html";
        public back_urls() {
